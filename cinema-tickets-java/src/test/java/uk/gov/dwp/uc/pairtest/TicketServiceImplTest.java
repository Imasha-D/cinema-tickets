...
class TicketServiceImplTest {
    ...
    class InvalidAccountTests {
        ...
        @Test
        void shouldThrowExceptionWhen_AccountIdIsNull() {
        ...
        @Test
        void shouldThrowExceptionWhen_AccountIdEqualsZero() {
            TicketTypeRequest req = request(Type.ADULT, 2);
            InvalidPurchaseException exception = assertThrows(
                    InvalidPurchaseException.class,
        ...
        @Test
        void shouldThrowExceptionWhen_AccountIdIsNegative() {
            TicketTypeRequest req = request(Type.ADULT, 2);
            InvalidPurchaseException exception = assertThrows(
                    InvalidPurchaseException.class,
    ...
    class InvalidTicketRequests {
        ...
        @Test
        void shouldThrowExceptionWhen_TicketRequestIsNull() {
        ...
        @Test
        void shouldThrowExceptionWhen_TicketRequestIsNotProvided() {
        ...
        @Test
        void shouldThrowExceptionWhen_RequestContainsNullTicketTypeRequest() {
        ...
        @Test
        void shouldThrowExceptionWhen_RequestHasNoTicketType() {
        ...
        @Test
        void shouldThrowExceptionWhen_RequestTicketQuantityIsZero() {
        ...
        @Test
        void shouldThrowExceptionWhen_RequestTicketQuantityIsNegative() {
    ...
    @Nested
    class validateBusinessLogics {

        // Rule 01; Max ticket count should be 25
        @Test
        void shouldThrowExceptionWhen_MoreThanTwentyFiveTicketsPurchased() {
        ...
        @Test
        void shouldThrowExceptionWhen_ChildTicketsWithoutAdult() {
        ...
        @Test
        void shouldThrowExceptionWhen_InfantTicketsWithoutAdult() {
        ...
        @Test
        void shouldThrowExceptionWhen_ChildAndInfantTicketsWithoutAdult() {
        ...
        @Test
        void shouldThrowExceptionWhen_InfantsMoreThanAdults() {
